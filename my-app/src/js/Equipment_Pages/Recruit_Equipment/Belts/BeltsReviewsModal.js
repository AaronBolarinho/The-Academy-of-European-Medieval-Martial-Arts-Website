...
class BeltsReviewsModal extends React.Component {
  constructor(props) {
    super(props)
  ...
  render() {
    ...
    return (
      <div>
        ...
        <Modal isOpen={this.state.modal} toggle={this.toggle} className='modalBelts'>
          ...
          <ModalBody>
            ...
            <Collapse isOpen={this.state.collapse}>
              <Card>
                <CardBody>
                  <Form action='/PeriodBeltsReviewsAdd' method='POST' target='_blank'>
                    <Row form>
                      <Col md={6}>
...
export default BeltsReviewsModal
