...
class PeriodGlovesReviewsModal extends React.Component {
  constructor(props) {
    super(props)
        ...
        <Modal isOpen={this.state.modal} toggle={this.toggle} className='modalGloves'>
          ...
          <ModalBody>
            ...
            <Collapse isOpen={this.state.collapse}>
              <Card>
                <CardBody>
                  <Form action='/PeriodGlovesReviewsAdd' method='POST' target='_blank'>
                    <Row form>
                      <Col md={6}>
...
export default PeriodGlovesReviewsModal
