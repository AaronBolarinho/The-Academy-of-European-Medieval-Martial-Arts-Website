...
class MasksReviewsModal extends React.Component {
  constructor(props) {
    super(props)
  ...
  render() {
    ...
    return (
      <div>
        ...
        <Modal isOpen={this.state.modal} toggle={this.toggle} className='modalMasks'>
          ...
          <ModalBody>
            ...
            <Collapse isOpen={this.state.collapse}>
              <Card>
                <CardBody>
                  <Form action='/FencingMasksReviewsAdd' method='POST' target='_blank'>
                    <Row form>
                      <Col md={6}>
...
export default MasksReviewsModal
