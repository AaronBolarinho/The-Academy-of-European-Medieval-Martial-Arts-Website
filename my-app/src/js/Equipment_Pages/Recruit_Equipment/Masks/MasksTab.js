...
import MasksReviewsModal from './MasksReviewsModal.js'
import FencingMask from '../../../../css/images/Equipment/fencingMask.jpg'

class MasksTab extends Component {
  constructor(props) {
    super(props)
  ...
  componentWillMount() {
    ...
    fetch('http://localhost:3003/FencingMasksReviews')
      .then(status)
      .then(json)
      .then((data) => {
      ...
      <>
        {products.map((products) => (
          <tr className='d-flex container'>
            ...
            <td className='col-3'>
              <MasksReviewsModal allReviews={reviews}
	     ...
	     <Row>
	          <Col sm='7'>
	            <p className='ConventionalShoesAdvice'>
	              <span className='generalAdviceTitle'>General Advice:</span><br></br><br></br> Masks made specifically for HEMA are recommended because they are typically more robust. Back of the head protection is also useful to have - it often either comes with the mask or is sold separately by the vendor.
              <br></br><br></br> Masks usually come in small-medium-large varieties, though these standard sizes can vary between vendors. The mask should fit your head snugly - ideally with the addition of coif (either thick or thin).
	            </p>
	          </Col>
          <Col sm='5'>
            <div className='tabImageDiv'>
              <img src={FencingMask} className='conventionalShoeImage' alt='Fencing Mask'/>
            </div>
            <div>
              <span className='imageLable'> Fencing Masks</span>
            </div>
          </Col>
	        </Row>
            ...
            <Form action='/FencingMasksProductAdd' method='POST'>
              <FormGroup>
                <Label for='exampleEmail'>Product Name</Label>
                <Input type='textarea'
                  name='createBrandName'
                  id='exampleText'
                  placeholder='HEMA Fencing Mask'
                  maxLength='49'
                  required/>
              ...
              <FormGroup>
                ...
                <Input type='textarea'
                  ...
                  id='exampleText'
                  maxLength='199'
                  placeholder='https://www.absolutefencinggear.com/shopping/product_info.php/products_id/1245/cPath/111'
                  required/>
