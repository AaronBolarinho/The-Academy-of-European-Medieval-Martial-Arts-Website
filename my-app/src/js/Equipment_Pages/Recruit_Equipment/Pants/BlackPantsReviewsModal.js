...
class BlackPantsReviewsModal extends React.Component {
  constructor(props) {
    super(props)
  ...
  render() {
    ...
    return (
      <div>
        ...
        <Modal isOpen={this.state.modal} toggle={this.toggle} className='modalPants'>
          ...
          <ModalBody>
            ...
            <Collapse isOpen={this.state.collapse}>
              <Card>
                <CardBody>
                  <Form action='/BlackPantsReviewsAdd' method='POST' target='_blank'>
                    <Row form>
                      <Col md={6}>
...
export default BlackPantsReviewsModal
