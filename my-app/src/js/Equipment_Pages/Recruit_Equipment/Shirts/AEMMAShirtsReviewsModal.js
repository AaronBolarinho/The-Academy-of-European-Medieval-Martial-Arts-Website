...
class AEMMAShirtsReviewsModal extends React.Component {
  constructor(props) {
    super(props)
        ...
        <Modal isOpen={this.state.modal} toggle={this.toggle} className='modalShirts'>
          ...
          <ModalBody>
            ...
            <Collapse isOpen={this.state.collapse}>
              <Card>
                <CardBody>
                  <Form action='/AEMMAShirtsReviewsAdd' method='POST' target='_blank'>
                    <Row form>
                      <Col md={6}>
...
export default AEMMAShirtsReviewsModal
