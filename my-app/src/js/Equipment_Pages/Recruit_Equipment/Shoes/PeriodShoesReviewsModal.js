...
class PeriodShoesReviewsModal extends React.Component {
  constructor(props) {
    super(props)
        ...
        <Modal isOpen={this.state.modal} toggle={this.toggle} className={this.props.className}>
          ...
          <ModalBody>
            ...
            <Collapse isOpen={this.state.collapse}>
              <Card>
                <CardBody>
                  <Form action='/PeriodShoesReviewsAdd' method='POST' target='_blank'>
                    <Row form>
                      <Col md={6}>
...
export default PeriodShoesReviewsModal
