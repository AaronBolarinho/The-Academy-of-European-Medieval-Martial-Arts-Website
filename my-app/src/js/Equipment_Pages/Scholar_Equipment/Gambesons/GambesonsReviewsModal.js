...
class GambesonsReviewsModal extends React.Component {
  constructor(props) {
    super(props)
  ...
  render() {
    ...
    return (
      <div>
        ...
        <Modal isOpen={this.state.modal} toggle={this.toggle} className='modalSwords'>
...
export default GambesonsReviewsModal
