<?php
// Program: content_trng_dagger_en.php
//	Description: source for the English textual content on the dagger page (trng_dagger.php)
//	2017 ------------------
//
// English content -------------------
$title[0] = "Dagger (daga)";
...
$dagger_class_image[0] = "dagger_class_1.jpg";
$dagger_class_image[1] = "dagger_class_2.jpg";
$dagger_class_image[2] = "dagger_class_2.jpg";

$dagger_class_image_caption[0] = "Instructing the student to strike with the dagger with intent to a specific target.";
$dagger_class_image_caption[1] = "Depicting a keylock technique as a control over the weapon wielding arm.";
$dagger_class_image_caption[2] = "Depicting another view of a keylock technique as a control over the weapon wielding arm.";
