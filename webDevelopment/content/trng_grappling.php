<?php
// 	Program: 	trng_grappling.php
//	Description: 	About the Academy, created January 15, 2017
//	Author:		David M. Cvet
//
//	2017 ------------------
//
...
$current_pgm = "trng_grappling.php";
include "../config/content_trng_grappling_$lang.php";
$path = "../";
...
$i = rand(0,1);		// randomize the armoured photos just to add a little spice to the page
$grappling_class_image[$lang_num] = $grappling_class_image[$i];
$grappling_class_image_caption[$lang_num] = $grappling_class_image_caption[$i];
?>
	<!-- begin main_content -->
	<div id="main_content">
		<h2><?=$title[$lang_num]?>&nbsp;<img src="<?=$path?>images/training/grappling.png" alt="" style="vertical-align:middle;" /></h2>
		...
		<div class="trng_poleweapons">
			<div style="float:left;"><a href="../images/training/<?=$grappling_class_image[$lang_num]?>" title="grappling classes"><img src="../images/training/<?=$grappling_class_image[$lang_num]?>" alt="grappling classes" width="100%" class="fade box" /></a></div>
			<div style="float:left;margin-top:15px;margin-bottom:15px;" class="caption"><?=$grappling_class_image_caption[$lang_num]?></div>
		</div>
