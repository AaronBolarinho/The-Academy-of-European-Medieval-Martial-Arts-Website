...
$current_pgm = "trng_rapier.php";
include "../config/content_trng_rapier_$lang.php";
$path = "../";
...
?>
	<!-- begin main_content -->
	<div id="main_content">
		<h2><?=$title[$lang_num]?>&nbsp;<img src="<?=$path?>images/training/rapier.png" alt="" style="vertical-align:middle;" /></h2>
