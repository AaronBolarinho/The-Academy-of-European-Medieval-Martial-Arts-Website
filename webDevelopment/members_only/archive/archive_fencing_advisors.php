...
$current_pgm = "archive_fencing_advisors.php";
$menu_selected = "admin";
...
$config_about = $path_members."config/content_archive_fencing_advisors_$lang.php"; include "$config_about";
...
?>
	<!-- begin main_content -->
	<div id="main_content">
		<h2><img src="<?=$path_members?>images/icons/archive.png" alt="" style="vertical-align:middle;width:40px;" /> <img src="<?=$path_members?>images/icons/fencing.png" alt="" style="vertical-align:middle;width:40px;" />&nbsp;<?=$title[$lang_num]?></h2>
		<p><?=$gb_p1[$lang_num]?></p>
		<div>
<?php
include "misc/fencing_advisors.htm";
?>
