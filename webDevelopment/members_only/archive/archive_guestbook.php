<?php
// 	Program: 	archive_guestbook.php
//	Description: 	Archival of the AEMMA guestbooks, created April 20, 2016
//	Author:		David M. Cvet
//
//	2019 ------------------
//	jan 25:	standardized path names
//
if (isset($_GET['YR'])) { $year = $_GET['YR']; } else { $year = "10"; }
if (isset($_GET['SPN'])) { $years_span = $_GET['SPN']; } else { $years_span = "1998 - 1999"; }
$guestbook = "gb_body_".$year.".htm";
...
$current_pgm = "archive_guestbook.php";
$menu_selected = "admin";
...
$config_about = $path_members."config/content_archive_guestbook_$lang.php"; include "$config_about";
$header = $path_members."php-bin/members_only_header.php"; include "$header";
echo ('<link rel="stylesheet" type="text/css" href="css/default_page.css" />');
$header2 = $path_members."php-bin/members_only_header2.php"; include "$header2";
?>
	<!-- begin main_content -->
	<div id="main_content">
		<h2><img src="<?=$path_members?>images/icons/archive.png" alt="" style="vertical-align:middle;width:40px;" /> <img src="<?=$path_members?>images/icons/notepad_pencil.png" alt="" style="vertical-align:middle;width:40px;" />&nbsp;<?=$title[$lang_num]?></h2>
		<p><?=$gb_p1[$lang_num]?></p>
		<div>
<?php
