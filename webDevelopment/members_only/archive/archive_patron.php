<?php
// 	Program: 	archive_patron.php
//	Description: 	Archive of the Patron of tournaments, created July 9, 2016
//	Author:		David M. Cvet
//
//	2019 ------------------
...
$current_pgm = "archive_patron.php";
$menu_selected = "admin";
...
$config_about = $path_members."config/content_archive_patron_$lang.php"; include "$config_about";
...
?>
	<!-- begin main_content -->
	<div id="main_content">
		<h2><img src="<?=$path_members?>images/icons/archive.png" alt="" style="vertical-align:middle;width:40px;" /> <img src="<?=$path_members?>images/icons/patron.jpg" alt="" style="vertical-align:middle;width:40px;" />&nbsp;<?=$title[$lang_num]?></h2>
		<p><?=$gb_p1[$lang_num]?></p>
		<div>
<?php
include "misc/patron.htm";
?>
