...
if (!picture_details || picture_details.closed)
	...
	picture_details = window.open("schoolDetails.htm","details","toolbar=no,menubar=no,scrollbars=yes,height=600,width=550")
	}
else
	{
	// goliath window is opened somewhere, bring it into focus
	picture_details.focus()
	picturedetails = window.open("schoolDetails.htm","details","toolbar=no,menubar=no,scrollbars=yes,height=600,width=550")
	}
