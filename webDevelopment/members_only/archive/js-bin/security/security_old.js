...
if (!helpWindow || helpWindow.closed)
	{
	helpWindow=window.open("http://www.aemma.org/help/secureManuscriptHelp.htm","helpWin_eClass","toolbar=no,scrollbars=yes,height=400,width=350")
	}
else
	{
...
function cancelMe()
{
top.location= "http://www.aemma.org/library_top.htm";
