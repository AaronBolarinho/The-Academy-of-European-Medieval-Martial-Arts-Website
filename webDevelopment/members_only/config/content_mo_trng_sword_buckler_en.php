<?php
// Program: content_mo_trng_sword_buckler_en.php
//	Description: source for the English textual content on the sword & buckler training page (mo_trng_sword_buckler.php)
//	2017 ------------------
//
// English content -------------------
$title[0] = "Sword & Buckler (spada e brocchiere)";
...
$about_trng_caption[0] = "The above images are randomly selected and presented folios (pages) from the oldest known Western martial arts treatise known as MS I.33 or as it's commonly referred to as the \"Tower Fechtbuch\"";

// array to store randomized sword & buckler photos
$sword_buckler_photo[0] = "sword_buckler_photo1.jpg";
$sword_buckler_photo[1] = "sword_buckler_photo2.jpg";
$sword_buckler_photo[2] = "sword_buckler_photo3.jpg";
$sword_buckler_image_caption[0] = "A class at AEMMA depicting students at a sword & buckler workshop held at the salle d'armes in November 2009.";
