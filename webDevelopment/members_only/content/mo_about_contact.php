...
$current_pgm = "mo_about_contact.php";
$menu_selected = "AEMMA";
...
$config_about = $path_members."config/content_mo_about_contact_$lang.php"; include "$config_about";
...
?>
	...
	<div id="main_content_mo">
		...
		<div class="contact_salles">
			...
			<h3><?=$general_contacts_title[$lang_num]?></h3>
			<p><?=$p1[$lang_num]?></p>
		</div>
		<div class="contact_salles">
