...
// 	Program: 	mo_about_contributing_member.php
...
$current_pgm = "mo_about_contributing_member.php";
$menu_selected = "AEMMA";
...
$config_about = $path_members."config/content_mo_about_contributing_member_$lang.php"; include "$config_about";
