...
$current_pgm = "mo_about_history.php";
$menu_selected = "AEMMA";
...
$config_about = $path_members."config/content_mo_about_history_$lang.php"; include "$config_about";
