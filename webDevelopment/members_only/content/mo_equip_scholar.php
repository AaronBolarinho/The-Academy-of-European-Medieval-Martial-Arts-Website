<?php
//  Program:  mo_equip_scholar.php
//  Description:  A presentation of the required and standard equipment for the rank of scholar, created June 11, 2019
//  Author:   Aaron Bolarinho
//
//  2019 ------------------
...
$current_pgm = "mo_equip_scholar.php";
...
?>
	...
	<!-- begin main_content -->
	<iframe src="http://localhost:3000/ScholarEquipment" width="100%" class="frameSize" scrolling="no" style="overflow:hidden;"/>
