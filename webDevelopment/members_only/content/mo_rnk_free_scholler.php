...
// 	Program: 	mo_rnk_free_scholler.php
//	Description: 	A members only detailed presentation of the rank of free scholler, created July 03, 2017
//	Author:		David M. Cvet
//
//	2019 ------------------
...
$current_pgm = "mo_rnk_free_scholler.php";
...
$config_about = $path_members."config/content_mo_rnk_free_scholler_$lang.php"; include "$config_about";
...
?>
	...
	<div id="main_content">
		...
		<li><a name="67"></a><?=$rnk_l67[$lang_num]?></li>
		<li><a name="68"></a><?=$rnk_l68[$lang_num]?></li>
		<li><a name="69"></a><?=$rnk_l69[$lang_num]?></li>
		</ul>
