<?php
// 	Program: 	mo_trng_pole_weapons.php
...
$current_pgm = "mo_trng_pole_weapons.php";
...
$config_about = $path_members."config/content_mo_trng_pole_weapons_$lang.php"; include "$config_about";
...
$poleweapon_image_caption[$lang_num] = $pole_weapon_photo_caption[$i];
?>
	<!-- begin main_content -->
	<div id="main_content_mo">
		...
		<div class="trng_poleweapons">
			<div style="float:left;"><a href="../images/training/<?=$pole_weapon_class[$lang_num]?>" title="armoured combat with spears"><img src="../images/training/<?=$pole_weapon_class[$lang_num]?>" alt="" width="100%" class="fade box" /></a></div>
			<div style="float:left;margin-top:15px;margin-bottom:15px;" class="caption"><?=$poleweapon_image_caption[$lang_num]?></div>
		</div>
