<?php
// 	Program: 	mo_trng_rapier.php
//	Description: 	rapier training page, created January 20, 2017
//	Author:		David M. Cvet
//
//	2019 ------------------
...
$current_pgm = "mo_trng_rapier.php";
...
$config_about = $path_members."config/content_mo_trng_rapier_$lang.php"; include "$config_about";
...
shuffle($liberi);	// shuffle the Liberi images within the array to randomize the presentation of the folios on this page
$i = rand(0,3);		// randomize the armoured photos just to add a little spice to the page
$rapier_image = $rapier_photo[$i];
?>
	<!-- begin main_content -->
	<div id="main_content_mo">
		<h2><?=$title[$lang_num]?>&nbsp;<img src="../../images/training/rapier.png" alt="" style="vertical-align:middle;" /></h2>
		...
		<div class="trng_poleweapons">
			<div style="float:left;"><a href="../images/training/<?=$rapier_image?>" title="armoured combat with poleaxe"><img src="../images/training/<?=$rapier_image?>" alt="" width="100%" class="fade box" /></a></div>
			<div style="float:left;margin-top:15px;margin-bottom:15px;" class="caption"><?=$rapier_photo_caption[$lang_num]?></div>
		</div>
