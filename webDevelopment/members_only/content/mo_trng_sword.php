...
$config_about = $path_members."config/content_mo_trng_sword_$lang.php"; include "$config_about";
...
$sword_class_image[$lang_num] = $sword_class_image[$i];
$sword_class_image_caption[$lang_num] = $sword_class_image_caption[$i];
?>
	<!-- begin main_content -->
	<div id="main_content_mo">
		<h2><?=$title[$lang_num]?>&nbsp;<img src="<?=$path?>images/training/sword.png" alt="" style="vertical-align:middle;" /></h2>
		...
		<div class="trng_poleweapons">
			<div style="float:left;"><a href="../images/training/<?=$sword_class_image[$lang_num]?>" title="longsword/arming sword classes"><img src="../images/training/<?=$sword_class_image[$lang_num]?>" alt="longsword/arming sword classes" width="100%" class="fade box" /></a></div>
			<div style="float:left;margin-top:15px;margin-bottom:15px;" class="caption"><?=$sword_class_image_caption[$lang_num]?></div>
		</div>
