<?php
// 	Program: 	mo_trng_sword_buckler.php
...
$current_pgm = "mo_trng_sword_buckler.php";
...
$config_about = $path_members."config/content_mo_trng_sword_buckler_$lang.php"; include "$config_about";
