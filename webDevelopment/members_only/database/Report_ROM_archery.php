<?php
// Program: Report_ROM_archery.php
// Author: David M. Cvet
// Created: March 18, 2008
// Description: This report will list all individuals who have taken the ROM/introductory archery/bow-making/arrow-making courses
//
//---------------------------
// Updates:
//	2012 ----------
...
?>
	...
	<?php
		...
		$SQL .= ' WHERE P.School = "AEMMA" and (P.Rec_ID = MC.People_ID and MC.Chapter_ID = 1) and (P.MemberStatus_ID = 3 or P.MemberStatus_ID = 4 or P.MemberStatus_ID = 5) and P.MemberType_ID = 9';
