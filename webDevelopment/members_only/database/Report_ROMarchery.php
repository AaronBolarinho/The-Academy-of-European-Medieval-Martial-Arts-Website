<?php
// Program: Report_ROMarchery.php
// Author: David M. Cvet
// Created: March 18, 2008
// Description: This report will list all students who have taken the ROM/internal archery courses, including bow-making and arrow-making
//
//---------------------------
// Updates:
//	2012 ----------
...
$header_title = "ROM Archery Students";
include 'sub_header.php';
?>
<table align="center" cellpadding="0" cellspacing="0" width="<?=$table_width?>">
<?php
	$full_date= date("d-m-Y");	
	echo ('<caption>ROM Archery Course Students : ('.$full_date.')</caption>');
?>
	...
	<?php
		...
		$SQL .= ' FROM People P';
		$SQL .= ' WHERE P.School = "'.$school.'" AND P.MemberType_ID = 9';
