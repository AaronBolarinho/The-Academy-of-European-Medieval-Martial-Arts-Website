...
<html>
	...
	<body align="center" valign="top" bgcolor="white">
		<table summary="Guelph membership listing for AEMMA" align="center" cellpadding="0" cellspacing="0" width="500">
<?php
...
?>
	...
	?>
	<tr>
		<td colspan="4"><font face="arial,helvetica" size=2><b>Note: </b> This listing includes members whose: a) membership status is "active" or "new" and b) members of Guelph only including "recruits & schollers & free schollers & provosts".</font></td>
	</tr>
