...
if ($s3) { echo ('<li id="Data"><b>Status = "Inactive"</b> : <font color="orange">records in orange</font> are individuals who no longer train at AEMMA.</li>'); }
if ($s4) { echo ('<li id="Data"><b>Status = "Resigned"</b> : <font color="gray">records in gray</font> are individuals who were members, but explicitly resigned from membership.</li>'); }
