...
//
		...
		$Result = mysql_query($SQL, $LinkID);
		while ($Line = mysql_fetch_object($Result)) {
			echo ('<tr bgcolor="gray"><td colspan=6><font face="arial,helvetica,sans-serif" size=-2 color="white">&nbsp;<b>Total active members ('.$Chapter_Name.'): '.$Line->Count.'</b></td></tr><tr><td colspan="5">&nbsp;</td></tr>');
		}
	...
	<tr>
	<?php
		echo ('<td colspan="4"><font face="arial,helvetica" size=2><b>Note: </b> This listing includes members whose: a) membership status is "active" or "new" and b) members of '.$Chapter_Name.' of any membership type.  "<b>Status</b>" indicates either "P" = currently paid up; "L" = lapsed membership payment as of date of this report; "S" = students who have suspended their training for a defined period of time and are highlighted in <font color="blue"><b>blue</b></font>.</font></td>');
	?>
