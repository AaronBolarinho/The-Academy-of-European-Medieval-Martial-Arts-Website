...
<?php
	...
	echo ('<caption>ROM Archery Listing: Toronto ('.$full_date.')</caption>');
?>
	...
	<?php
		...
		$SQL .= ' WHERE P.School = "AEMMA" and (P.ID = MC.People_ID and MC.Chapter_ID = 1) and (P.MemberStatus_ID = 1 or P.MemberStatus_ID = 2 or P.MemberStatus_ID = 3 or P.MemberStatus_ID = 4 or P.MemberStatus_ID = 5) and P.MemberType_ID = 9';
	...
	?>
	<tr>
		<td colspan="4"><font face="arial,helvetica" size=2><b>Note: </b>ROM swordsmanship lists individuals whose a) membership category is identified as "ROM archery"; and b) membership status is "new / inactive / resigned / lost".</font></td>
	</tr>
