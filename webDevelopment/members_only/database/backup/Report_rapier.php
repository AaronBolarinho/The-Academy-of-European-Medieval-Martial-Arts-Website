...
<?php
	...
	echo ('<caption>Active Membership Listing: Italian Rapier  ('.$full_date.')</caption>');
?>
	...
	<?php
		...
		$SQL .= ' WHERE P.School = "AEMMA" and (P.ID = MM.People_ID and MM.rapier = 1) and (P.MemberStatus_ID = 2 or P.MemberStatus_ID = 1 or P.MemberStatus_ID = 6)';
	...
	?>
	<tr>
		<td colspan="4"><font face="arial,helvetica" size="-2"><b>Note: </b>Italian rapier members are whose a) membership type is identified as "any"; b) membership status is "active" or "new"; and c) train at AEMMA Toronto or Guelph, and records highlighted in <font color="blue">"blue"</font> are suspended due to work or health reasons.</font></td>
	</tr>
