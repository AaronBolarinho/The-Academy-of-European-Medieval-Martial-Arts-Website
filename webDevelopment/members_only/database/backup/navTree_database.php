...
<!-- Class Attendance Tracking -->
	<li><a href="index.php?PGM=Main&SCH='.$school.'&LGID='.$login_ID.'&RID='.$uRec_ID.'&SECL='.$seclvl.'">&nbsp;&nbsp;&nbsp;&nbsp;Attendance Tracking</a></li>
		<li><a href="index.php?PGM=class_attendance&SCH='.$school.'&CHAP=1&LGID='.$login_ID.'&RID='.$uRec_ID.'&SECL='.$seclvl.'">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Toronto Classes</a></li>
		<li><a href="index.php?PGM=class_attendance&SCH='.$school.'&CHAP=2&LGID='.$login_ID.'&RID='.$uRec_ID.'&SECL='.$seclvl.'">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Guelph Classes</a></li>
		<li><a href="index.php?PGM=class_attendance&SCH='.$school.'&CHAP=3&LGID='.$login_ID.'&RID='.$uRec_ID.'&SECL='.$seclvl.'">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Digby Classes</a></li>
		<li><a href="index.php?PGM=class_attendance&SCH='.$school.'&CHAP=5&LGID='.$login_ID.'&RID='.$uRec_ID.'&SECL='.$seclvl.'">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Stratford Classes</a></li>
<!-- Active Mem. Reports -->
	<li><a href="index.php?PGM=Main&SCH='.$school.'&LGID='.$login_ID.'&RID='.$uRec_ID.'&SECL='.$seclvl.'">&nbsp;&nbsp;&nbsp;&nbsp;Active Mem. Reports</a></li>
		...
		<li><a href="index.php?PGM=Report_chapter&SCH='.$school.'&LGID='.$login_ID.'&RID='.$uRec_ID.'&SECL='.$seclvl.'&Chapter=1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Toronto Members</a></li>
		<li><a href="index.php?PGM=Report_chapter&SCH='.$school.'&LGID='.$login_ID.'&RID='.$uRec_ID.'&SECL='.$seclvl.'&Chapter=2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Guelph Members</a></li>
		<li><a href="index.php?PGM=Report_chapter&SCH='.$school.'&LGID='.$login_ID.'&RID='.$uRec_ID.'&SECL='.$seclvl.'&Chapter=3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NS Members</a></li>
		<li><a href="index.php?PGM=Report_chapter&SCH='.$school.'&LGID='.$login_ID.'&RID='.$uRec_ID.'&SECL='.$seclvl.'&Chapter=5">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Stratford Members</a></li>
<!-- Misc. Reports -->
